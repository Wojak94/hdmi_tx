...
#
# Generated by Vivado on Thu Jul 12 13:17:38 CEST 2018
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../HDMI_Transmitter.srcs/sources_1/bd/design_1/ipshared/4903" \
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/design_1/ip/design_1_timing_0_0/sim/design_1_timing_0_0.vhd" \
  2>&1 | tee -a vhdlan.log

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../HDMI_Transmitter.srcs/sources_1/bd/design_1/ipshared/4903" \
  ...
  vlogan -work util_vector_logic_v2_0_1 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../HDMI_Transmitter.srcs/sources_1/bd/design_1/ipshared/4903" \
    "$ref_dir/../../../../HDMI_Transmitter.srcs/sources_1/bd/design_1/ipshared/2137/hdl/util_vector_logic_v2_0_vl_rfs.v" \
  2>&1 | tee -a vlogan.log
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/design_1/ip/design_1_image_gen_0_0/sim/design_1_image_gen_0_0.vhd" \
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/wojak/Vivado_Projects/HDMI_Transmitter/HDMI_Transmitter.cache/compile_simlib/vcs"
  fi
