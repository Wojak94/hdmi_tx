...
HD_PWD='/home/wojak/Vivado_Projects/HDMI_Transmitter/HDMI_Transmitter.runs/design_1_image_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_image_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_image_gen_0_0.tcl
